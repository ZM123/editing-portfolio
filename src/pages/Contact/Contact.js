...
const ContactLink = ({ icon, label, to }) => {
  return (
    <a href={to} className={styles.contactLink}>
      ...
      <div className={styles.contactPage}>
        ...
        <div className={styles.contactMeSection}>
          ...
          <div className={styles.contactLinks}>
            ...
            <ContactLink icon={LinkedIn} label="linkedin.com/zal-machado" to="https://www.linkedin.com/in/zal-machado/" />
          </div>
        </div>
        <div />
      </div>
